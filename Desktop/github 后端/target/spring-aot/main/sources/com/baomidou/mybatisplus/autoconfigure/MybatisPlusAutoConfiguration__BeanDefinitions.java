...
public class MybatisPlusAutoConfiguration__BeanDefinitions {
  ...
  public static BeanDefinition getDdlApplicationRunnerBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition();
    beanDefinition.setTargetType(DdlApplicationRunner.class);
    beanDefinition.setInstanceSupplier(getDdlApplicationRunnerInstanceSupplier());
    return beanDefinition;
  }

  /**
   * Bean definitions for {@link MybatisPlusAutoConfiguration.MapperScannerRegistrarNotFoundConfiguration}.
   */
  public static class MapperScannerRegistrarNotFoundConfiguration {
    ...
    public static BeanDefinition getMapperScannerRegistrarNotFoundConfigurationBeanDefinition() {
      RootBeanDefinition beanDefinition = new RootBeanDefinition(MybatisPlusAutoConfiguration.MapperScannerRegistrarNotFoundConfiguration.class);
      beanDefinition.setTargetType(MybatisPlusAutoConfiguration.MapperScannerRegistrarNotFoundConfiguration.class);
      ConfigurationClassUtils.initializeConfigurationClass(MybatisPlusAutoConfiguration.MapperScannerRegistrarNotFoundConfiguration.class);
      beanDefinition.setInstanceSupplier(MybatisPlusAutoConfiguration$MapperScannerRegistrarNotFoundConfiguration$$SpringCGLIB$$0::new);
      return beanDefinition;
    }
  }
}
