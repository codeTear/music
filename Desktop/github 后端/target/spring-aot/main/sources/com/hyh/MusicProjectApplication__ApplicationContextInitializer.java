 ...
 */
public class MusicProjectApplication__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new MusicProjectApplication__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new MusicProjectApplication__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
